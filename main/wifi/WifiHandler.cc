...
WifiMode WifiHandler::_mode = WifiMode::AP;
...
bool WifiHandler::load_wifi_credentials(std::string &ssid, std::string &password)
{
...
void WifiHandler::save_wifi_credentials(const std::string &ssid, const std::string &password)
{
    nvs_handle_t my_handle;
